...
object MoreFunctionProvider {
    ...
    val functions = listOf(
            Function(R.drawable.discover_ic_other_course, R.string.discover_title_other_course, R.string.discover_detail_other_course, StartActivityAfterLogin("同学课表", DISCOVER_OTHER_COURSE), OldClickEvent.CLICK_KBCX_ENTRY),
            Function(R.drawable.discover_ic_map, R.string.discover_title_map, R.string.discover_detail_map, StartActivityImpl(DISCOVER_MAP), OldClickEvent.CLICK_CYDT_ENTRY),
            Function(R.drawable.discover_ic_no_class, R.string.discover_title_no_class, R.string.discover_detail_no_class, StartActivityAfterLogin("没课约", DISCOVER_NO_CLASS), OldClickEvent.CLICK_MKY_ENTRY),
            Function(R.drawable.discover_ic_bus_track, R.string.discover_title_bus_track, R.string.discover_detail_bus_track, StartActivityImpl(DISCOVER_SCHOOL_CAR), OldClickEvent.CLICK_XCGJ_ENTRY),
            Function(R.drawable.discover_ic_empty_classroom, R.string.discover_title_empty_classroom, R.string.discover_detail_empty_classroom, StartActivityImpl(DISCOVER_EMPTY_ROOM), OldClickEvent.CLICK_YLC_KJS_ENTRY),
            Function(R.drawable.discover_ic_school_calendar, R.string.discover_title_school_calendar, R.string.discover_detail_school_calendar, StartActivityImpl(DISCOVER_CALENDAR), OldClickEvent.CLICK_YLC_XL_ENTRY),
            Function(R.drawable.discover_ic_todo,R.string.discover_title_todo, R.string.discover_detail_todo, StartActivityImpl(DISCOVER_TODO_MAIN), OldClickEvent.CLICK_YZQD_ENTRY),
            Function(R.drawable.discover_ic_sport, R.string.discover_title_sport, R.string.discover_detail_sport, StartActivityAfterLogin("体育打卡", DISCOVER_SPORT), OldClickEvent.CLICK_YLC_TYDK_ENTRY),
            Function(R.drawable.discover_ic_my_exam, R.string.discover_title_my_exam, R.string.discover_detail_my_exam, StartActivityAfterLogin("我的考试", DISCOVER_GRADES), OldClickEvent.CLICK_YLC_WDKS_ENTRY),
    ...
    class Function(var resource: Int, val title: Int, val detail: Int, val activityStarter: StartActivityAble?, val clickEvent: OldClickEvent? = null)
