...
kotlin {
  sourceSets {
    jsMain.dependencies {
      ...
      // distribution -> language:javascript -> language:js-bridge/npm:js-bridge。
...
npmJsPackage {
  // Runtime 是所有动态 Kotlin/JS 包的长期公共依赖，坐标不得跟随 Gradle 模块路径变化。
  packageName.set("@cyxbs-mobile/kotlin-js-runtime")
