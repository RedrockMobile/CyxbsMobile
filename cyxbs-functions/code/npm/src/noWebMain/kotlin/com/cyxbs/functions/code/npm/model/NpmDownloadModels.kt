 ...
 * [com.cyxbs.functions.code.npm.pool.NpmPackagePool] 实例首次使用该入口时刷新一次，实例生命周期内不重复检查。
 */
...
enum class NpmRefreshPolicy {
   ...
   * 默认的低频刷新策略。
   *
   * - [NpmEntryVersion.Latest]：每个 [com.cyxbs.functions.code.npm.pool.NpmPackagePool] 实例首次使用该入口时检查一次 registry，
